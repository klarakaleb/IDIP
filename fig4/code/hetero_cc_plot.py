...
cc = np.load("cc/IDIP/cc.npy")
cc2 = np.load("cc/vogels/cc.npy")
...
hetero = np.load("hetero/IDIP/hetero_repeats1.npy")[:, : len(TIME)]
hetero2 = np.load("hetero/IDIP/hetero_repeats2.npy")[:, : len(TIME)]
...
mean_fr_hetero = np.load("hetero/IDIP/mean_fr.npy")
mean_fr = np.load("hetero/IDIP/mean_fr_nh.npy")
