...
for i in range(len(dirs)):
    ...
    dirname = str(dirs[i])
    print(dirname)
    fr0_i = np.load(dirname + "3/0fr_trial.npy")
    fr1_i = np.load(dirname + "3/1fr_trial.npy")
    fr2_i = np.load(dirname + "3/fr_trial.npy")
    w0_i = np.load(dirname + "3/0w_i_trial.npy")
    w1_i = np.load(dirname + "3/1w_i_trial.npy")
    w2_i = np.load(dirname + "3/w_i_trial.npy")
...
np.save("fr_inh.npy", fr_inh)
np.save("w.npy", weights)
