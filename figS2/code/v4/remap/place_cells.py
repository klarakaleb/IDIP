...
def run(CA1_I_w, CA3_CA1_w):
    ...
    for i in range(0, LEN_TIME * N_RUNS, 1):
        ...
        if n_runs >= 0:
            ...
            theta_m[N2E:] = theta_m[N2E:] - ETA_I * A_I * delta_w * s[N2E:]
            # EXCITATORY LEARNING
        ...
        thetas.append(theta_m.copy())
        s[:] = 0

    return w_in, w_i, spikes, i_inputs, thetas
...
w_in, w_i, spikes, inputs, thetas = run(CA1_I_w, CA3_CA1_w)
