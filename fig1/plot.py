...
e_input2 = np.genfromtxt("data/0e_input.txt")
i_input2 = np.genfromtxt("data/0i_input.txt")
TIME = np.arange(0, 30, 0.001)


c0 = get_binned_current(e_input2, 1000, TIME) * 0.01
ci0 = get_binned_current(i_input2, 1000, TIME) * 0.01
...
e_input2 = np.genfromtxt("data/99e_input.txt")
i_input2 = np.genfromtxt("data/99i_input.txt")
TIME = np.arange(0, 30, 0.001)
...
fr0 = np.genfromtxt("data/0fr_trial.csv", delimiter=",")
# fr99 = np.genfromtxt('data/99fr_trial.csv',delimiter=',')
