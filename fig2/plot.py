...
fr_silent = np.load("data/fr_silent.npy")
fr_active = np.load("data/fr_active.npy")
...
fr_silent = np.load("data/fr_silent_ni.npy")
fr_active = np.load("data/fr_active_ni.npy")
