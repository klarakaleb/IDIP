...
R = 100 * 1000000  # membrane resistance [Ohm]
...
# synapses
GS = 1 / 1000000000  # basic unit of synaptic conductance [S]
...
THETA_I = 5.5 / 10000000  # target input for inhibitory neurons
...
T = 1500  # total time [s]
TIME = np.arange(0, T, DT)  # simulation time [s]
...
w, spikes, i_inputs = run(v, w_rec, w_in)
