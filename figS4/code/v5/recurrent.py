...
ETA_I = 0.1  # inhibitory learning rate
A_I = 0.00001  # inhibitory learning amplitude
...
THETA_FR = 100  # target fr for inhibitory neurons
...
def run(v, w_rec):
    ...
    for i in range(0, LEN_TIME, 1):
        ...
        if t > 15:
            # INHIBITORY LEARNING
            dw = ETA_I * (fr_est / TAU_EST - THETA_FR) * s[N2E:]
