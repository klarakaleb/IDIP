...
N2 = 100 * scale  # recurrent layer
N2E = 80 * scale  # of which excitatory
...
ETA_I = 0.1 * (1 / scale) / 1e6  # inhibitory learning rate
...
random_weights[w_in_mask.sum() :] *= 1 / scale
